...
## Phase 0 — Archive and boundaries
...
- [ ] Define seeker registration minimums.
- [ ] Define SMS command language and multilingual strategy.
- [ ] Define inventory categories and allergy/restriction handling.
...
- [ ] Build a local demonstration with simulated SMS messages.
- [ ] Implement inventory publication.
...
- [ ] Test with people using basic phones.
- [ ] Test accessibility, language, literacy, and disability needs.
...
- [ ] Document a stable integration interface.
- [ ] Add adapters only when a real nonprofit use case is identified.
- [ ] Keep the core system usable without any vendor-specific integration.

## Phase 5 — Daily Harvest & Biblical Foodway pathway

- [ ] Model same-day inspection, selection, harvesting, cataloging, ordering, bundling, and distribution.
