...
- confusing intelligence with unrestricted action
...
- **PROPOSED:** intentional design proposal
- **SPECULATIVE:** conceptual possibility not yet demonstrated
- **UNKNOWN:** unresolved
...
4. define the overlap operation
5. define what qualifies as emergence
6. define human confirmation
7. test the smallest possible prototype
